...
//    }
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="articlesdropdown">
            ...
            // Call the category list method from the dbHandler to retrieve the actua categories from the database
            ...
            if($data['error']==false){
                ...
                <span class="badge badge-pill badge-light">'.$total.'</span> '.$category.'</a>';
                }
            }
            
            ?>
            
<!--            <a class="dropdown-item" href="articlesbycategory.php?id=1">
                <span class="badge badge-pill badge-light">2</span> Database Security</a>-->
            <a class="dropdown-item" href="articlesbycategory.php?id=7">
                <span class="badge badge-pill badge-light">3</span> General Web Security</a>
            <a class="dropdown-item" href="articlesbycategory.php?id=4">
                <span class="badge badge-pill badge-light">2</span> HTML 5</a>
